...
describe('testing user role', () => {
  ...
  it('should be able to read', (done) => {
    ...
    return mockRequest.post('/signup')
      ...
      .then(results => {
        expect(results.text).toEqual('Route /read success!');
        done();
      });
  });
...
describe('testing writer role', () => {
  ...
  it('should be able to add', (done) => {
    ...
    return mockRequest.post('/signup')
      ...
      .then(results => {
        expect(results.text).toEqual('Route /add success!');
        done();
      });
  });
...
describe('testing editor role', () => {
  ...
  it('should be able to update', (done) => {
    ...
    return mockRequest.post('/signup')
      ...
      .then(results => {
        expect(results.text).toEqual('Route /change success!');
        done();
      });
  });
...
describe('testing admin role', () => {
  ...
  it('should be able to delete', (done) => {
    ...
    return mockRequest.post('/signup')
      ...
      .then(results => {
        expect(results.text).toEqual('Route /remove success!');
        done();
      });
  });
